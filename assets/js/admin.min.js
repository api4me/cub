jQuery(document).ready(function($){
    ...
    $("#article #delete-modal button[name='delete']").click(function(){
        $("button").attr("disabled","true");
        var $base = $("input[type='hidden'][name='base-article']:first").attr("value");
        var id = $("input[type='hidden'][name='id']").val();
        $.post($base + "/admin/article/delete", {id: id}, function(data){
            if (data.status == 0) {
                $("#delete-modal-msg").attr("class","alert fade in");
                $("#delete-modal-msg").text(data.msg);
                $("#delete-modal-msg").alert();
                setTimeout(function(){location.href = $base + "/admin/article/";}, 1000);
            } else {
                $("#delete-modal-msg").attr("class","alert alert-block alert-error fade in");
                $("#delete-modal-msg").text(data.msg);
                $("#delete-modal-msg").alert();
